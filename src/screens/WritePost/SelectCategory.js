        ...
        <Container>
            ...
            <ScrollView style={{backgroundColor: '#53B77C' ,borderRadius: 10}}>
                ...
                <View style={styles.centerView}>
                    <View >
                        <TouchableOpacity style={[styles.boxView]} onPress={() => {props.setCategory("서류")}}>
                    ...
                    <View >
                        <TouchableOpacity style={[styles.boxView]} onPress={() => {props.setCategory("마트")}}>
                ...
                <View style={styles.centerView}>
                    <View >
                        <TouchableOpacity style={[styles.boxView]} onPress={() => {props.setCategory("과제")}}>
                    ...
                    <View >
                        <TouchableOpacity style={[styles.boxView]} onPress={() => {props.setCategory("공구")}}>
                ...
                <View style={[styles.centerView, { marginBottom: 20}]}>
                    <View >
                        <TouchableOpacity style={[styles.boxView]} onPress={() => {props.setCategory("짐")}}>
                    ...
                    <View >
                        ...
                        <TouchableOpacity style={[styles.boxView]} onPress={() => {props.setCategory("생각")}}>
